...
public class ELAdvancementProvider extends AdvancementProvider {
    ...
    public static class Generator implements AdvancementProvider.AdvancementGenerator {
        ...
        public void generate(HolderLookup.Provider provider, Consumer<AdvancementHolder> consumer, ExistingFileHelper existingFileHelper) {
            ...
            ).requirements(AdvancementRequirements.Strategy.OR).addCriterion("has_item", InventoryChangeTrigger.TriggerInstance.hasItems(EnigmaticItems.THE_ACKNOWLEDGMENT)).save(consumer,  prefix("root"));
