...
public class ELRecipeProvider extends RecipeProviderWithHelper {
    ...
    protected void buildRecipes(RecipeOutput output) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EnigmaticItems.ENDER_RING)
                ...
                .save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EnigmaticItems.INFERNAL_RING)
                .pattern("CNC").pattern("BXB").pattern("CGC")
                .define('C', EnigmaticItems.INFERNAL_CINDER).define('G', Items.GHAST_TEAR)
                .define('N', Items.NETHERITE_SCRAP).define('B', Items.BLAZE_POWDER).define('X', EnigmaticItems.IRON_RING)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EnigmaticItems.BLANK_SCROLL)
                ...
                .save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EnigmaticItems.SURVIVOR_SCROLL)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EnigmaticItems.EXPLORER_SCROLL)
                ...
                .unlockedBy("has_item", has(EnigmaticItems.BLANK_SCROLL))
                .save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EnigmaticItems.HUNTER_SCROLL)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EnigmaticItems.XP_SCROLL)
                ...
                .unlockedBy("has_item", has(EnigmaticItems.BLANK_SCROLL))
                .save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EnigmaticItems.ESCAPE_SCROLL)
                .pattern("SYS").pattern("BXI").pattern("ERE")
                .define('E', Items.PHANTOM_MEMBRANE).define('S', Items.SOUL_LANTERN)
                .define('R', EnigmaticItems.RECALL_POTION).define('Y', Items.ENDER_EYE)
                .define('B', Items.INK_SAC).define('I', Items.FEATHER).define('X', EnigmaticItems.BLANK_SCROLL)
                .unlockedBy("has_item", has(EnigmaticItems.BLANK_SCROLL))
                .save(output);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EnigmaticItems.ODE_TO_LIVING)
                ...
                .define('Y', Items.GOLDEN_APPLE).define('I', EnigmaticItems.ICHOR_DROPLET)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, EnigmaticItems.EXECUTION_AXE)
                ...
                .define('P', EnigmaticItems.INFERNAL_CINDER).define('R', Items.BLAZE_ROD).define('V', Items.WITHER_SKELETON_SKULL)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, EnigmaticItems.ICHOR_SPEAR, 2)
                ...
                .unlockedBy("has_item", has(EnigmaticItems.ICHOR_DROPLET))
                .save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, EnigmaticItems.INFERNAL_SPEAR)
                .pattern(" AS").pattern("BXA").pattern("AB ")
                .define('X', EnigmaticItems.ICHOR_SPEAR).define('A', EnigmaticItems.INFERNAL_CINDER)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, EnigmaticItems.DRAGON_BREATH_BOW)
                ...
                .define('X', Items.DRAGON_HEAD).define('N', EnigmaticItems.ETHERIUM_INGOT)
        ...
        CursedShapedRecipe.Builder.shaped(RecipeCategory.MISC, EnigmaticItems.BLESS_AMPLIFIER)
                ...
                .unlockedBy("has_item", has(EnigmaticItems.SACRED_CRYSTAL))
                .save(output);
        CursedShapedRecipe.Builder.shaped(RecipeCategory.MISC, EnigmaticItems.SCORCHED_CHARM)
                .pattern("N N").pattern("QXQ").pattern("EPE")
                .define('N', Items.NETHERITE_SCRAP)
                .define('E', Blocks.BASALT).define('P', EnigmaticItems.PURE_HEART)
                .define('X', EnigmaticItems.BLAZING_CORE).define('Q', EnigmaticItems.SACRED_CRYSTAL)
                .unlockedBy("has_item", has(EnigmaticItems.SACRED_CRYSTAL))
                .save(output);
        ...
        CursedShapedRecipe.Builder.shaped(RecipeCategory.MISC, EnigmaticItems.BLESS_STONE)
                ...
                .save(output);
        CursedShapedRecipe.Builder.shaped(RecipeCategory.MISC, EnigmaticItems.THUNDER_SCROLL)
                .pattern("ISI").pattern("BXY").pattern("EPE")
                .define('B', Items.INK_SAC).define('Y', Items.FEATHER)
                .define('I', EnigmaticItems.ICHOR_DROPLET).define('S', EnigmaticItems.OCEAN_STONE)
                .define('E', Items.LAPIS_LAZULI).define('P', EnigmaticItems.SACRED_CRYSTAL)
                .define('X', EnigmaticItems.DARKEST_SCROLL)
                .unlockedBy("has_item", has(EnigmaticItems.SACRED_CRYSTAL))
                .save(output);
        ...
        CursedShapedRecipe.Builder.shaped(RecipeCategory.MISC, EnigmaticItems.DESOLATION_RING)
                ...
                .unlockedBy("has_item", has(EnigmaticItems.ABYSSAL_HEART))
                .save(output);
        CursedShapedRecipe.Builder.shaped(RecipeCategory.MISC, EnigmaticItems.VIOLENCE_SCROLL)
                .pattern("CAC").pattern("EXE").pattern("TVT")
                .define('C', EnigmaticItems.COSMIC_HEART).define('T', EnigmaticItems.TWISTED_HEART)
                .define('E', EnigmaticItems.EVIL_ESSENCE).define('V', EnigmaticItems.CURSE_TRANSPOSER)
                .define('X', EnigmaticItems.CURSED_SCROLL).define('A', EnigmaticItems.ABYSSAL_HEART)
                .unlockedBy("has_item", has(EnigmaticItems.ABYSSAL_HEART))
                .save(output);
