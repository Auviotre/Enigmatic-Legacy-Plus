    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> output) {
        ...
        output.accept(Chests.NETHER_SIMPLE,
                LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        ...
                        .add(LootItem.lootTableItem(EnigmaticItems.ICHOR_CURSE_BOTTLE).when(LootItemRandomChanceCondition.randomChance(0.8F)).setWeight(20))
        ...
        output.accept(Chests.END_SIMPLE,
                LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        ...
                        .add(LootItem.lootTableItem(EnigmaticItems.STARLIGHT_PARTICLE).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))).setWeight(10))
