...
public class ELGlobalModifier extends GlobalLootModifierProvider {
    ...
    protected void start() {
        ...
        this.addChest(Chests.GOLEM_HEART, ABANDONED_MINESHAFT, SIMPLE_DUNGEON, VILLAGE_ARMORER);
        ...
        this.addChest(Chests.REVIVAL_LEAF, JUNGLE_TEMPLE, JUNGLE_TEMPLE_DISPENSER);
