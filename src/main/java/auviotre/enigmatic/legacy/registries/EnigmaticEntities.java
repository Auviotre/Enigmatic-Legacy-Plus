...
public class EnigmaticEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ExplorerMarker>> EXPLORER_MARKER = register("explorer_marker", EntityType.Builder.<ExplorerMarker>of(ExplorerMarker::new, MobCategory.MISC).sized(1.0F, 1.0F).eyeHeight(0.5F).clientTrackingRange(64).fireImmune());
    public static final DeferredHolder<EntityType<?>, EntityType<PermanentItemEntity>> PERMANENT_ITEM_ENTITY = register("permanent_item_entity", EntityType.Builder.<PermanentItemEntity>of(PermanentItemEntity::new, MobCategory.MISC).sized(0.25F, 0.25F).eyeHeight(0.2F).clientTrackingRange(64).updateInterval(10));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EngineHook>> ENGINE_HOOK = register("engine_hook", EntityType.Builder.<EngineHook>of(EngineHook::new, MobCategory.MISC).sized(0.2F, 0.2F).eyeHeight(0.1F).clientTrackingRange(64).updateInterval(20).fireImmune());
    public static final DeferredHolder<EntityType<?>, EntityType<AngelBeam>> ANGEL_BEAM = register("angel_beam", EntityType.Builder.<AngelBeam>of(AngelBeam::new, MobCategory.MISC).sized(0.16F, 0.16F).eyeHeight(0.08F).clientTrackingRange(64).updateInterval(20).fireImmune());
