...
public class DragonBreathArrow extends AbstractArrow {
    ...
    private void summonAreaEffect() {
        ...
        float dmg = Mth.ceil(Mth.clamp(Math.sqrt(speed) * this.getBaseDamage(), 0.0, 2.147483647E9)) / 4.5F;
        ...
        effectCloud.addEffect(new MobEffectInstance(MobEffects.HARM, 1, Mth.floor(Mth.sqrt(dmg))));
